...
| 2 | Daily AI News Digest | Fetches news daily and sends digest to Telegram |
| 3 | YT Study Notes | Takes YouTube URL → transcript → summary to Google Drive |
| 4 | PDF Summarizer | Reads PDF from Drive → extracts key points → saves to Drive |
